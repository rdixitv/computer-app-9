...
- [[#89][89]]
  ...
  - [[#output-89][Output]]
- [[#90][90]]
  - [[#variable-listing-86][Variable Listing]]
  - [[#output-90][Output]]
- [[#91][91]]
  - [[#variable-listing-87][Variable Listing]]
  - [[#output-91][Output]]
- [[#92][92]]
  - [[#variable-listing-88][Variable Listing]]
  - [[#output-92][Output]]
...
| Variable Name | Data Type | Description                          |
|---------------+-----------+--------------------------------------|
| i             | int       | Loop counter variable of outer loops |
| j             | int       | Loop counter variable of inner loops |
** Output
#+begin_src
a
aa
...
| grade         | int       | Stores the student's class               |
| name          | String    | Stores the student's name                |
| sum           | double    | Stores the sum of a student's marks      |
| i             | int       | Loop counter variable for the outer loop |
| j             | int       | Loop counter variable for the inner loop |
** Output
#+begin_src
Enter roll number: 5
Enter name: R
Enter class: 9
Enter subject 1 marks: 97.5
Enter subject 2 marks: 97
Enter subject 3 marks: 100
...
Enter subject 10 marks: 97
5. R
Class - 9
Avg - 96.325
